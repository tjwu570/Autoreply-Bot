...
class DataArguments:
    ...
    train_path: str = field(default='./data/processed_data.txt', metadata={"help": "Train dataset file path."})
    dev_path: str = field(default='./data/processed_data.txt', metadata={"help": "Dev dataset file path."})
    test_path: str = field(default='./data/processed_data.txt', metadata={"help": "Test dataset file path."})
    label_path: str = field(default='./data/label.txt', metadata={"help": "Label file path."})
    bad_case_path: str = field(default='./data/badcase.txt', metadata={"help": "Bad case file path."})
